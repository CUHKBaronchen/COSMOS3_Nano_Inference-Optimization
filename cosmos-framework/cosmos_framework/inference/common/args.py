...
class SampleArgs(ArgsBase):
    ...
    initial_noise_file: ResolvedFilePath | None
    save_initial_noise: bool
...
class SampleOverrides(OverridesBase):
    ...
    initial_noise_file: ResolvedFilePath | None = None
    """Optional safetensors file containing an ``initial_noise`` tensor."""

    save_initial_noise: bool = False
    """Save the exact initial diffusion noise next to the generated output."""
