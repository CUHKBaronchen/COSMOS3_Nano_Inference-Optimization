...
OUTPUT_DIR="$OUTPUT_ROOT/cudagraph_${MODE}_$RUN_ID"
...
mkdir -p "$OUTPUT_DIR" /tmp/cosmos3-p1-cudagraph-inductor /tmp/cosmos3-p1-cudagraph-triton
...
export TORCHINDUCTOR_CACHE_DIR=/tmp/cosmos3-p1-cudagraph-inductor
export TRITON_CACHE_DIR=/tmp/cosmos3-p1-cudagraph-triton
