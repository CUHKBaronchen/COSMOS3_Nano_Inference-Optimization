...
EXPERIMENT_ROOT="$ROOT/cosmos3_t2v_p2"
...
DEFAULTS_FILE="$EXPERIMENT_ROOT/configs/cfg_interval_800_1000_defaults.json"
OUTPUT_DIR="$EXPERIMENT_ROOT/outputs/cfg_interval_800_1000_$RUN_ID"
...
mkdir -p "$OUTPUT_DIR" /tmp/cosmos3-torchinductor-cache /tmp/cosmos3-triton-cache
